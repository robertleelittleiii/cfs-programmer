...
#ifndef CFS_PROGRAMMER_SWIFT_H
#define CFS_PROGRAMMER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CFS_Programmer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14CFS_Programmer16BluetoothManager")
...
@class NSString;
@class NSNumber;
@interface BluetoothManager (SWIFT_EXTENSION(CFS_Programmer)) <CBCentralManagerDelegate>
...
@interface BluetoothManager (SWIFT_EXTENSION(CFS_Programmer)) <CBPeripheralDelegate>
